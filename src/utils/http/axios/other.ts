...
const httpServer = (config: any) => {
  ...
  if (import.meta.env.DEV) {
    baseURL = import.meta.env.VITE_OTHER_API_URL + import.meta.env.VITE_OTHER_API_URL_PREFIX;
  } else {
    baseURL = `${window.location.origin}${import.meta.env.VITE_OTHER_API_URL_PREFIX}`;
  }
