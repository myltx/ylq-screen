const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-C07df3JC.js","assets/index-CLRggEId.js","assets/index-CHAwV9Dv.css","assets/index-BAQgF5sQ.js","assets/index-Bi_xhAZw.css"])))=>i.map(i=>d[i]);
...
let __tla = (async ()=>{
    ...
    const Om = [
        ...
        },
        {
            path: "/login",
            name: "Login",
            component: ()=>ki(()=>import("./index-C07df3JC.js"), __vite__mapDeps([0,1,2]))
        },
        {
            path: "/index",
            name: "Index",
            component: ()=>ki(()=>import("./index-BAQgF5sQ.js"), __vite__mapDeps([3,1,4]))
        }
    ], bo = pm({
        history: Wg("/"),
        routes: Om
