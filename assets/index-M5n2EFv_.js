const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CqQrCkUi.js","assets/index-Cd2rnkRA.js","assets/index-BjdJe-OI.css","assets/index-BMOjswfV.js","assets/index-J8DT3XyI.css"])))=>i.map(i=>d[i]);
...
let __tla = (async ()=>{
    ...
    const Om = [
        ...
        },
        {
            path: "/login",
            name: "Login",
            component: ()=>ki(()=>import("./index-CqQrCkUi.js"), __vite__mapDeps([0,1,2]))
        },
        {
            path: "/index",
            name: "Index",
            component: ()=>ki(()=>import("./index-BMOjswfV.js"), __vite__mapDeps([3,1,4]))
        }
    ], bo = pm({
